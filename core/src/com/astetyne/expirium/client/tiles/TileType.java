...
public enum TileType implements Textureable {
    ...
    GRASS_SLOPE_R(Solidity.LABILE, TileTex.GRASS_SLOPE_R, 4f, Item.GRASS, 1, TileFix.GRASS_SLOPE_R),
    GRASS_SLOPE_L(Solidity.LABILE, TileTex.GRASS_SLOPE_L, 4f, Item.GRASS, 1, TileFix.GRASS_SLOPE_L),
    ...
    TREE4(Solidity.LABILE_SOFT, TileTex.TREE4, 3f, new ItemDropper(new Item[]{Item.APPLE}, 0.5f), 1),
    TREE5(Solidity.LABILE_SOFT, TileTex.TREE5, 3f, new ItemDropper(new Item[]{Item.APPLE}, 0.5f), 1),
    TREE6(Solidity.LABILE_SOFT, TileTex.TREE6, 3f, new ItemDropper(new Item[]{Item.APPLE}, 0.5f), 1),
    CAMPFIRE_SMALL(Solidity.LABILE, TileTexAnim.CAMPFIRE_SMALL, 0.5f, Item.EMPTY, 1, TileFix.CAMPFIRE),
    CAMPFIRE_BIG(Solidity.LABILE, TileTexAnim.CAMPFIRE_BIG, 0.5f, Item.EMPTY, 1, TileFix.CAMPFIRE),
