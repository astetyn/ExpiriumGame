...
public enum ItemRecipe {
    ...
    TORCH(Item.TORCH, new ItemStack[]{new ItemStack(Item.PLANKS, 2), new ItemStack(Item.DRY_LEAVES, 4)}, "Light it up!"),
    ...
    CAMPFIRE(Item.CAMPFIRE, new ItemStack[]{new ItemStack(Item.RAW_WOOD, 10), new ItemStack(Item.DRY_LEAVES, 5)}, "Make it if you are cold. It will warm your small house."),
